...
class Events extends Component {
  ...
  activeRegistrationStatus = () => {
    ...
    const activeEventDetails = eventsList.find(event => event.id === eventId)
          ...
          <ul className="events-list">
            {eventsList.map(each => (
              <EventItem
                ...
                isActive={each.id === eventId}
              />
            ))}
          </ul>
        </div>
        <ActiveEventRegistrationDetails
          activeEventRegStatus={this.activeRegistrationStatus()}
        />
      </div>
    )
  }
